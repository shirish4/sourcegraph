...
func (h *handler) prepareWorkspace(ctx context.Context, commandRunner command.Runner, repositoryName, repositoryDirectory, commit string, shallowClone bool, sparseCheckout []string) (_ string, err error) {
